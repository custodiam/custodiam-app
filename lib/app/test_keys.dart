...
abstract final class K {
  ...
  static const Key drawerNotificacionesTile = ValueKey(
    'drawer_notificaciones_tile',
  );
  ...
  static const Key drawerAdministracionTile = ValueKey(
    'drawer_administracion_tile',
  );
  ...
  static const Key homeQuickActionDisponibilidad = ValueKey(
    'home_quick_action_disponibilidad',
  );
  static const Key homeQuickActionServicios = ValueKey(
    'home_quick_action_servicios',
  );
  static const Key homeQuickActionEmergencia = ValueKey(
    'home_quick_action_emergencia',
  );
  ...
  static const Key altaMaterialDescripcion = ValueKey(
    'alta_material_descripcion',
  );
  static const Key altaMaterialCodigo = ValueKey('alta_material_codigo');
  static const Key altaMaterialNumeroSerie = ValueKey(
    'alta_material_numero_serie',
  );
  ...
  static const Key altaVehiculoMarcaModelo = ValueKey(
    'alta_vehiculo_marca_modelo',
  );
  static const Key altaVehiculoItv = ValueKey('alta_vehiculo_itv');
  static const Key altaVehiculoObservaciones = ValueKey(
    'alta_vehiculo_observaciones',
  );
  ...
  static const Key materialFichaAbrirMapaBtn = ValueKey(
    'material_ficha_abrir_mapa',
  );
  static const Key materialFichaAsignarPersonal = ValueKey(
    'material_ficha_asignar_personal',
  );
  ...
  static const Key materialAsignarVoluntarioSelector = ValueKey(
    'material_asignar_voluntario_selector',
  );
  static const Key materialAsignarCantidad = ValueKey(
    'material_asignar_cantidad',
  );
  static const Key materialAsignarConfirm = ValueKey(
    'material_asignar_confirm',
  );

  // ---- Inventario — Ficha material (diálogo devolver) ------------------
  static const Key materialDevolverVoluntarioSelector = ValueKey(
    'material_devolver_voluntario_selector',
  );
  static const Key materialDevolverObservaciones = ValueKey(
    'material_devolver_observaciones',
  );
  static const Key materialDevolverConfirm = ValueKey(
    'material_devolver_confirm',
  );

  // ---- Inventario — Ficha material (diálogo incidencia) ----------------
  static const Key materialIncidenciaDescripcion = ValueKey(
    'material_incidencia_descripcion',
  );
  static const Key materialIncidenciaConfirm = ValueKey(
    'material_incidencia_confirm',
  );

  // ---- Inventario — Ficha vehículo --------------------------------------
  static const Key vehiculoFichaRefresh = ValueKey('vehiculo_ficha_refresh');
  static const Key vehiculoFichaAbrirMapaBtn = ValueKey(
    'vehiculo_ficha_abrir_mapa',
  );
  ...
  static const Key vehiculoIncidenciaDescripcion = ValueKey(
    'vehiculo_incidencia_descripcion',
  );
  static const Key vehiculoIncidenciaConfirm = ValueKey(
    'vehiculo_incidencia_confirm',
  );

  // ---- Inventario — Listado ---------------------------------------------
  static const Key inventarioAltaMenu = ValueKey('inventario_alta_menu');
  static const Key inventarioMaterialSearch = ValueKey(
    'inventario_material_search',
  );
  static const Key inventarioMaterialListView = ValueKey(
    'inventario_material_list_view',
  );
  static Key inventarioMaterialItem(String materialId) =>
      ValueKey('inventario_material_item_$materialId');
  static const Key inventarioVehiculoSearch = ValueKey(
    'inventario_vehiculo_search',
  );
  static const Key inventarioVehiculoListView = ValueKey(
    'inventario_vehiculo_list_view',
  );
  ...
  static const Key inventarioMaterialEditarItem = ValueKey(
    'inventario_material_editar_item',
  );
  static const Key inventarioMaterialBorrarItem = ValueKey(
    'inventario_material_borrar_item',
  );
  static const Key inventarioVehiculoEditarItem = ValueKey(
    'inventario_vehiculo_editar_item',
  );
  static const Key inventarioVehiculoBorrarItem = ValueKey(
    'inventario_vehiculo_borrar_item',
  );

  // ---- Inventario — Crear ubicación (diálogo) ---------------------------
  static const Key crearUbicacionNombre = ValueKey('crear_ubicacion_nombre');
  static const Key crearUbicacionDescripcion = ValueKey(
    'crear_ubicacion_descripcion',
  );
  ...
  static const Key ubicacionFormDescripcion = ValueKey(
    'ubicacion_form_descripcion',
  );
  ...
  static const Key dotacionAnadirConfirm = ValueKey('dotacion_anadir_confirm');
  static const Key dotacionQuitarConfirm = ValueKey('dotacion_quitar_confirm');

  // ---- Servicios — Alta servicio ----------------------------------------
  static const Key altaServicioTitulo = ValueKey('alta_servicio_titulo');
  static const Key altaServicioUbicacion = ValueKey('alta_servicio_ubicacion');
  static const Key altaServicioUbicacionMapaBtn = ValueKey(
    'alta_servicio_ubicacion_mapa',
  );
  static const Key altaServicioQuitarCoordsBtn = ValueKey(
    'alta_servicio_quitar_coords',
  );
  static const Key altaServicioFechaInicioBtn = ValueKey(
    'alta_servicio_fecha_inicio',
  );
  static const Key altaServicioDescripcion = ValueKey(
    'alta_servicio_descripcion',
  );
  static const Key altaServicioFechaFinBtn = ValueKey(
    'alta_servicio_fecha_fin',
  );
  static const Key altaServicioNumeroVoluntarios = ValueKey(
    'alta_servicio_numero_voluntarios',
  );
  static const Key altaServicioNotasMaterial = ValueKey(
    'alta_servicio_notas_material',
  );
  static const Key altaServicioNotasVehiculos = ValueKey(
    'alta_servicio_notas_vehiculos',
  );
  ...
  // ---- Servicios — Listado ----------------------------------------------
  static const Key serviciosListFiltroFechasBtn = ValueKey(
    'servicios_filtro_fechas_button',
  );
  static const Key serviciosListRefreshBtn = ValueKey(
    'servicios_refresh_button',
  );
  static const Key serviciosListSearchField = ValueKey(
    'servicios_search_field',
  );
  ...
  static const Key serviciosListFilterTodosChip = ValueKey(
    'servicios_filter_todos',
  );
  static const Key serviciosListFilterPublicadoChip = ValueKey(
    'servicios_filter_publicado',
  );
  static const Key serviciosListFilterActivoChip = ValueKey(
    'servicios_filter_activo',
  );
  static const Key serviciosListFilterBorradorChip = ValueKey(
    'servicios_filter_borrador',
  );
  static const Key serviciosListFilterCerradoChip = ValueKey(
    'servicios_filter_cerrado',
  );
  static const Key serviciosListRangoActivoChip = ValueKey(
    'servicios_chip_rango_activo',
  );
  static Key serviciosListItem(String servicioId) =>
      ValueKey('servicios_item_$servicioId');

  // ---- Servicios — Ficha detalle ----------------------------------------
  static const Key servicioFichaRefreshBtn = ValueKey('servicio_ficha_refresh');
  static const Key servicioFichaAbrirMapaBtn = ValueKey(
    'servicio_ficha_abrir_mapa',
  );
  static const Key servicioFichaApuntarseBtn = ValueKey(
    'servicio_ficha_apuntarse_button',
  );
  static const Key servicioFichaDesapuntarseBtn = ValueKey(
    'servicio_ficha_desapuntarse_button',
  );
  static const Key servicioFichaPublicarBtn = ValueKey(
    'servicio_ficha_publicar_button',
  );
  static const Key servicioFichaConvocarBtn = ValueKey(
    'servicio_ficha_convocar_button',
  );
  static const Key servicioFichaCerrarBtn = ValueKey(
    'servicio_ficha_cerrar_button',
  );
  static const Key servicioFichaCerrarObservacionesField = ValueKey(
    'servicio_ficha_cerrar_observaciones',
  );
  static const Key servicioFichaCerrarConfirmBtn = ValueKey(
    'servicio_ficha_cerrar_confirm',
  );
  static const Key servicioFichaFichajeAccesoBtn = ValueKey(
    'servicio_ficha_fichaje_acceso',
  );
  static const Key servicioFichaEditarBtn = ValueKey('servicio_ficha_editar');
  static const Key servicioFichaBorrarBtn = ValueKey('servicio_ficha_borrar');
  static const Key servicioFichaInscritoChip = ValueKey(
    'servicio_ficha_inscrito_chip',
  );

  // ---- Servicios — Personal del servicio (A9) ---------------------------
  static const Key servicioPersonalSection = ValueKey(
    'servicio_personal_section',
  );
  ...
  static const Key servicioRecursosTipoMaterialBtn = ValueKey(
    'recursos_tipo_material',
  );
  static const Key servicioRecursosTipoVehiculoBtn = ValueKey(
    'recursos_tipo_vehiculo',
  );
  static const Key servicioRecursosCantidadField = ValueKey(
    'recursos_cantidad',
  );
  static const Key servicioRecursosCantidadConfirmBtn = ValueKey(
    'recursos_cantidad_confirm',
  );
  static Key servicioRecursoQuitarBtn(String asignacionId) =>
      ValueKey('recursos_quitar_$asignacionId');

  // ---- Voluntarios — Ficha admin ----------------------------------------
  static const Key voluntarioFichaRefreshButton = ValueKey(
    'voluntario_ficha_refresh',
  );
  static const Key voluntarioFichaDarBajaButton = ValueKey('ficha_dar_baja');
  static const Key voluntarioFichaAnonimizarButton = ValueKey(
    'ficha_anonimizar',
  );
  ...
  static const Key voluntarioFichaFechaNacimientoField = ValueKey(
  ...
  // ---- Voluntarios — Listado --------------------------------------------
  static const Key voluntariosListAltaButton = ValueKey(
    'voluntarios_alta_button',
  );
  static const Key voluntariosListRefreshButton = ValueKey(
    'voluntarios_refresh_button',
  );
  static const Key voluntariosListSearchField = ValueKey(
    'voluntarios_search_field',
  );
  static const Key voluntariosListListView = ValueKey('voluntarios_list_view');
  static const Key voluntariosListFilterTodosChip = ValueKey(
    'voluntarios_filter_todos',
  );
  static const Key voluntariosListFilterActivosChip = ValueKey(
    'voluntarios_filter_activos',
  );
  static const Key voluntariosListFilterBajaChip = ValueKey(
    'voluntarios_filter_baja',
  );
  static const Key voluntariosListFilterSuspendidosChip = ValueKey(
    'voluntarios_filter_suspendidos',
  );
  static Key voluntariosListItem(String voluntarioId) =>
      ValueKey('voluntarios_item_$voluntarioId');

  // ---- Voluntarios — Mi perfil ------------------------------------------
  static const Key miPerfilRefreshButton = ValueKey('mi_perfil_refresh_button');
  static const Key miPerfilTileHoras = ValueKey('mi_perfil_tile_horas');
  static const Key miPerfilTileDisponibilidad = ValueKey(
    'mi_perfil_tile_disponibilidad',
  );
  static const Key miPerfilTileHistorial = ValueKey('mi_perfil_tile_historial');
  static const Key miPerfilEditButton = ValueKey('mi_perfil_edit_button');

  // ---- Voluntarios — Editar mi perfil -----------------------------------
  static const Key editarMiPerfilTelefonoField = ValueKey(
    'editar_perfil_telefono',
  );
  static const Key editarMiPerfilEmailField = ValueKey('editar_perfil_email');
  static const Key editarMiPerfilMunicipioField = ValueKey(
    'editar_perfil_municipio',
  );
  static const Key editarMiPerfilDireccionField = ValueKey(
    'editar_perfil_direccion',
  );
  static const Key editarMiPerfilFotoField = ValueKey('editar_perfil_foto');
  static const Key editarMiPerfilSubmitButton = ValueKey(
    'editar_perfil_submit',
  );
  static const Key editarMiPerfilCancelButton = ValueKey(
    'editar_perfil_cancel',
  );
  ...
  static const Key altaVoluntarioFechaNacimientoField = ValueKey(
  ...
  static const Key locationPickerConfirmarAppBarBtn = ValueKey(
    'location_picker_confirmar',
  );
  static const Key locationPickerDireccionField = ValueKey(
    'location_picker_direccion',
  );
  static const Key locationPickerRecargarBtn = ValueKey(
    'location_picker_recargar',
  );
  static const Key locationPickerConfirmarBtn = ValueKey(
    'location_picker_confirmar_btn',
  );
  static const Key locationPickerMantenerBtn = ValueKey(
    'location_picker_mantener',
  );
  static const Key locationPickerUsarSugerenciaBtn = ValueKey(
    'location_picker_usar_sugerencia',
  );
  ...
  // ---- Fichaje — En servicio --------------------------------------------
  static const Key fichajeEnServicioSalidaButton = ValueKey(
    'fichaje_salida_button',
  );
  static const Key fichajeEnServicioEntradaButton = ValueKey(
    'fichaje_entrada_button',
  );
  static const Key fichajeEnServicioVoluntariosRefresh = ValueKey(
    'voluntarios_fichados_refresh',
  );
  ...
  static const Key miDisponibilidadRefresh = ValueKey(
    'mi_disponibilidad_refresh',
  );
  static const Key miDisponibilidadPrevMonth = ValueKey(
    'mi_disponibilidad_prev_month',
  );
  static const Key miDisponibilidadNextMonth = ValueKey(
    'mi_disponibilidad_next_month',
  );
  static Key miDisponibilidadDia(int dia) =>
      ValueKey('mi_disponibilidad_dia_$dia');

  // ---- Historial — Mi historial -----------------------------------------
  static const Key miHistorialFiltroFechas = ValueKey(
    'mi_historial_filtro_fechas',
  );
  static const Key miHistorialRefresh = ValueKey('mi_historial_refresh');
  static const Key miHistorialChipRangoActivo = ValueKey(
    'mi_historial_chip_rango_activo',
  );
  static const Key miHistorialFiltroTodos = ValueKey(
    'mi_historial_filtro_todos',
  );
  static Key miHistorialFiltroTipo(String wire) =>
      ValueKey('mi_historial_filtro_$wire');

  // ---- Notificaciones — Ajustes -----------------------------------------
  static const Key notifAjustesEmergencias = ValueKey(
    'notif_ajustes_emergencias',
  );
  static const Key notifAjustesNuevosServicios = ValueKey(
    'notif_ajustes_nuevos_servicios',
  );
  static const Key notifAjustesRecordatorios = ValueKey(
    'notif_ajustes_recordatorios',
  );
}
